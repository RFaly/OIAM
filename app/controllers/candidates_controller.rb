class CandidatesController < ApplicationController
  ...
  def confirmedProfil
    ...
    is_error = params[:cadre_info][:question1].empty? || params[:cadre_info][:question2].empty? || params[:cadre_info][:question3].empty? || params[:cadre_info][:question4].empty? || params[:cadre_info][:question5].empty? || params[:cadre_info][:status].empty? || params[:cadre_info][:disponibilite].empty?
    if is_error
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  def post_params
    params.require(:cadre_info).permit(:question1,:question2,:question3,:question4,:question5,:status,:disponibilite)
  end
