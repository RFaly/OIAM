...
ActiveRecord::Schema.define(version: 2020_09_28_121912) do
  ...
  create_table "promise_to_hires", force: :cascade do |t|
    ...
    t.boolean "client_time_trying"
    t.boolean "cadre_time_trying", default: false
    t.boolean "prime_received", default: false
